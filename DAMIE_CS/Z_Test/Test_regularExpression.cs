...
{
	sealed class Test_regularExpression
	{
#region   - Filenames -  文件名列表
		private static string[] Filenames = new string[] {"测斜报表-001-2012-11-13.xls",
...
#endregion
		private static string DirectorName = "F:\\基坑数据\\1_ 监测资料与地勘报告\\B03-A1\\03A监测报表\\测斜-商飞";
		static public void Main()
		{
			string fn = Filenames[0]; // "测斜报表-001-2012-11-13.xls"
			fn = "测斜报表-001-2012-11-13.xls";
			fn = "测斜报表- 001-  2012 -11-  13  .xls";
			string pattern = "报表-\\s*(\\d{3})\\s*-\\s*(\\d{4})\\s*-\\s*(\\d{2})\\s*-\\s*(\\d{2})\\s*";
